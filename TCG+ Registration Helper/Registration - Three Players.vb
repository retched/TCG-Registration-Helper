Public Class frmTrios
    ...
    End Sub
    Private Sub btnClearPlayer3_Click(sender As Object, e As EventArgs) Handles btnClearPlayer3.Click
        txtMemberNo3.Clear()
        txtPlayerFirstName3.Clear()
        txtPlayerLastName3.Clear()
        txtPlayerNickname3.Clear()
    End Sub

    Private Sub frmTrios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAddTeam_Click(sender As Object, e As EventArgs) Handles btnAddTeam.Click
        ...
        If String.IsNullOrWhiteSpace(txtMemberNo3.Text) Or String.IsNullOrWhiteSpace(txtPlayerNickname3.Text) Then
            tcTeams.SelectedTab = tpPlayerC
            txtMemberNo2.Focus()
            MessageBox.Show("Missing Player C details.")
            Exit Sub
        End If

        ' Are the three member number boxes NOT the same? (It's OK if they're both GUEST99999)
        'If txtMemberNo1.Text = txtMemberNo2.Text Or txtMemberNo1.Text = txtMemberNo3.Text Or txtMemberNo2.Text = txtMemberNo3.Text Then
        '    MessageBox.Show("Some players details are identical to each other. Please double check the membership number and try again.")
        '    Exit Sub
        'End If

        If {txtMemberNo1.Text, txtMemberNo2.Text, txtMemberNo3.Text}.Distinct().Count() < 3 Then
            MessageBox.Show("Some players details are identical to each other. Please double check the membership number and try again.")
            Exit Sub
        End If
        ...
        If dgvTeams.SelectedRows.Count = 0 Then
            ...
            For Each team In lstTournTeams
                ...
                If team.CheckTeam(txtMemberNo3.Text) Then blnNotInTeam = False
            Next
        ...
        If Not IsNothing(lstStaff.Find(Function(x) x.MembershipNumber = txtMemberNo1.Text.Trim())) Or Not IsNothing(lstStaff.Find(Function(x) x.MembershipNumber = txtMemberNo2.Text.Trim())) Or Not IsNothing(lstStaff.Find(Function(x) x.MembershipNumber = txtMemberNo3.Text.Trim())) Then
        ...
        If dgvTeams.SelectedRows.Count Then
            ...
            lstTournTeams(dgvTeams.SelectedRows(0).Cells("dgcListIndex").Value) = New TournamentTeam With {
                        ...
                        .PlayerC = New PlayerInfo() With {
                            .FirstName = txtPlayerFirstName3.Text.Trim(),
                            .LastName = txtPlayerLastName3.Text.Trim(),
                            .MembershipName = txtPlayerNickname3.Text.Trim(),
                            .MembershipNumber = txtMemberNo3.Text.Trim(),
                            .SeatOrder = "C"},
        ...
        ' Add/Update Player 3 Info
        UpdateAllPlayerXML(txtMemberNo3.Text, txtPlayerNickname3.Text, txtPlayerFirstName3.Text, txtPlayerLastName3.Text)
    ...
    Private Sub txtMemberNo1_Leave(sender As Object, e As EventArgs) Handles txtMemberNo1.Leave, txtMemberNo2.Leave, txtMemberNo3.Leave
    ...
    Private Sub FindPlayerFromList(strPlayerNo As String, sender As Object)
        ...
        Dim objTXTArray As Object() = {txtMemberNo1, txtMemberNo2, txtMemberNo3}

        Dim fnTXTArray As Object() = {txtPlayerFirstName1, txtPlayerFirstName2, txtPlayerFirstName3}
        Dim lnTXTArray As Object() = {txtPlayerLastName1, txtPlayerLastName2, txtPlayerLastName3}
        Dim mnTXTArray As Object() = {txtPlayerNickname1, txtPlayerNickname2, txtPlayerNickname3}
    ...
    Private Sub BuildTournamentList()
        ...
        For Each team In lstTournTeams
            ...
            Dim tpPlayerC As PlayerInfo = lstPlayers.Find(Function(x) x.MembershipNumber = team.PlayerC.MembershipNumber)
            ...
            team.PlayerC.FirstName = tpPlayerC.FirstName
            team.PlayerC.LastName = tpPlayerC.LastName
            team.PlayerC.MembershipName = tpPlayerC.MembershipName

            dgvTeams.Rows.Add(lstTournTeams.IndexOf(team), False, team.TeamName, "Seat A: " & team.PlayerA.ListSummary & Environment.NewLine & "Seat B: " & team.PlayerB.ListSummary & Environment.NewLine & "Seat C: " & team.PlayerC.ListSummary, IIf(team.ByeRounds, "Yes", "No"), _status.Item(team.Status))
        Next
    ...
    Private Sub txtMemberNo1_KeyDown(sender As Object, e As KeyEventArgs) Handles txtMemberNo1.KeyDown, txtMemberNo2.KeyDown, txtMemberNo3.KeyDown
    ...
    Private Sub txtMemberNo1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtMemberNo1.KeyPress, txtMemberNo2.KeyPress, txtMemberNo3.KeyPress
    ...
    Private Sub dgvTeams_SelectionChanged(sender As Object, e As EventArgs) Handles dgvTeams.SelectionChanged
        If dgvTeams.SelectedRows.Count = 1 Then
            ...
            txtMemberNo3.Text = tdSelected.PlayerC.MembershipNumber
            txtPlayerFirstName3.Text = tdSelected.PlayerC.FirstName
            txtPlayerLastName3.Text = tdSelected.PlayerC.LastName
            txtPlayerNickname3.Text = tdSelected.PlayerC.MembershipName
    ...
    Private Sub lbSearchResults_SelectedValueChanged(sender As Object, e As EventArgs) Handles lbSearchResults.SelectedValueChanged
        If lbSearchResults.SelectedItems.Count Then
            Select Case tcTeams.SelectedTab.Name
                ...
                Case "tpPlayerC"
                    FindPlayerFromList(lbSearchResults.SelectedValue, txtMemberNo3)
            End Select
        End If
    End Sub
    ...
    Private Sub ToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem2.Click
        ...
        If SaveFileDialogCSV.ShowDialog(Me) = DialogResult.OK Then
            ...
            Using csvDoc As IO.StreamWriter = My.Computer.FileSystem.OpenTextFileWriter(FileName, False)
                csvDoc.WriteLine("""Team ID"",""Team Name"",""Win Point"",""Status"",""Bye Count"",""Membership Number - 1"",""Player Name - 1"",""Seat Order - 1"",""Membership Number - 2"",""Player Name - 2"",""Seat Order - 2"",""Membership Number - 3"",""Player Name - 3"",""Seat Order - 3"",""Memo""")
...
No change in value will have any effect."",""Required""")
                ...
                For Each team In lstTournTeams
                    If team.Status <> 9999 Then
                        ...
                        csvDoc.Write("""" & team.PlayerC.MembershipNumber & """,")
                        csvDoc.Write("""" & team.PlayerC.MembershipName & """,")
                        csvDoc.Write("""" & team.PlayerC.SeatOrder & """,")
                        csvDoc.Write("""" & "Player A - " & team.PlayerA.PlayerFullName & Environment.NewLine & "Player B - " & team.PlayerB.PlayerFullName & Environment.NewLine & "Player C - " & team.PlayerC.PlayerFullName & """")
    ...
    Private Sub TournamentXMLxmlToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TournamentXMLxmlToolStripMenuItem.Click
        ...
        If Not String.IsNullOrWhiteSpace(FileName) Then
            ...
            tournament.SetAttributeValue("TeamPlayers", 3) ' Trios Player tournament.
            ...
            For Each team In lstTournTeams
                playerNode.Add(New XElement("Team", New XElement("TeamID", team.TeamID),
                                                    ...
                                                    New XElement("Players", New XElement("Player",
                                                                            ...
                                                                            New XElement("Player",
                                                                                         New XElement("MemberNumber", team.PlayerC.MembershipNumber),
                                                                                         New XElement("MemberName", team.PlayerC.MembershipName),
                                                                                         New XElement("PlayerFirstName", team.PlayerC.FirstName),
                                                                                         New XElement("PlayerLastName", team.PlayerC.LastName),
                                                                                         New XElement("SeatOrder", team.PlayerC.SeatOrder)))))
            Next
    ...
    Private Sub ToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem3.Click
        ...
        If SaveFileDialogXML.ShowDialog(Me) = DialogResult.OK Then
            ...
            Dim tournament As XElement = New XElement("Tournament")
            tournament.SetAttributeValue("TeamPlayers", 3) ' One player tournament.
...
No change in value will have any effect."",""Required""")
    ...
    Private Sub AddNewPlayersFromImport()
        ...
        For Each team In lstTournTeams
            ...
            UpdateAllPlayerXML(team.PlayerC.MembershipNumber, team.PlayerC.MembershipName, team.PlayerC.FirstName, team.PlayerC.LastName)
        Next
